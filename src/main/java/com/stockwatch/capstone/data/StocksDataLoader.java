...
public class StocksDataLoader implements CommandLineRunner {
    ...
    private void loadStocksData() {
        ...
        BigDecimal marketCap1 = new BigDecimal("9.19E150");
        BigDecimal marketCap2 = new BigDecimal("1.85E127");
        BigDecimal marketCap3 = new BigDecimal("1.98E125");
        BigDecimal marketCap4 = new BigDecimal("6.71E114");
        BigDecimal marketCap5 = new BigDecimal("1.38E112");
        BigDecimal marketCap6 = new BigDecimal("4.88E113");
        BigDecimal marketCap7 = new BigDecimal("4.46E102");
        BigDecimal marketCap8 = new BigDecimal("3.58E105");
        BigDecimal marketCap9 = new BigDecimal("3.82E119");
        BigDecimal marketCap10 = new BigDecimal("9.0E112");
        ...
        Stock stock1 = new Stock(101, "CVS Health Corporation", "CVS", 71.75, 2.14, 5.0, marketCap1);
        stockRepository.save(stock1);
        Stock stock2 = new Stock(102, "Alphabet Inc.", "GOOGL", 150.20, 10.0, 4.1, marketCap2);
        stockRepository.save(stock2);
        Stock stock3 = new Stock(103, "Microsoft Corporation", "MSFT", 300.60, 5.0, 4.2, marketCap3);
        stockRepository.save(stock3);
        Stock stock4 = new Stock(104, "Berkshire Hathaway", "BRKA", 421.50, 5200.0, 4.3, marketCap4);
        stockRepository.save(stock4);
        Stock stock5 = new Stock(105, "Target Corporation", "TGT", 230.10, 2.5, 4.6, marketCap5);
        stockRepository.save(stock5);
        Stock stock6 = new Stock(106, "Walmart Inc.", "WMT", 140.36, 1.8, 4.1, marketCap6);
        stockRepository.save(stock6);
        Stock stock7 = new Stock(107, "Carvana Co.", "CVNA", 350.45, 4.2, 4.2, marketCap7);
        stockRepository.save(stock7);
        Stock stock8 = new Stock(108, "Chewy Inc.", "CHWY", 100.01, 1.5, 3.9, marketCap8);
        stockRepository.save(stock8);
        Stock stock9 = new Stock(109, "Netflix Inc.", "NFLX", 500.09, 5.7, 4.2, marketCap9);
        stockRepository.save(stock9);
        Stock stock10 = new Stock(110, "Facebook Inc.", "FB", 330.20, 3.9, 4.3, marketCap10);
        stockRepository.save(stock10);
        Stock stock11 = new Stock(111, "Nano Labs Ltd", "NA", 2.72, 1.3, 4.7, marketCap11);
